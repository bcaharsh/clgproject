...
function NavList() {
  return (
    <ul className="backdrop-blur lg:backdrop-blur-0 rounded-lg flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        as="li"
        variant="small"
        color="white"
...
export default function Header() {
  ...
  return (
    <>
      <div>
        {/* <div className="h-5 bg-active"></div> */}
        {/* navigation bar start */}
        <Navbar color="transparent" className="absolute rounded-none z-10 mx-auto max-w-full px-6 py-3" >
